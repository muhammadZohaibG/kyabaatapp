  ...
  List<Map> newCategoriesList = [
    {
      ...
      'dataList': [
        ...
        CategoriesModel(
            ...
            womenVoice: selectedLang == 'Urdu'
                ? 'audios/womenAudios/urduLanguage/myCondition/pain1.mp3'
    ...
    },
    {
      ...
      'dataList': [
        ...
        CategoriesModel(
            ...
            womenVoice:selectedLang == 'Urdu'
                ? 'audios/womenAudios/urduLanguage/callTo/nurse.mp3'
                : 'audios/womenAudios/callTo/nurse.mp3'),
        CategoriesModel(
            name: 'Nursing Assistant'.tr,
            image: 'assets/asstNurse.png',
            menVoice: 'audios/menAudios/callTo/nursingAsst.mp3',
            womenVoice:selectedLang == 'Urdu'
                ? 'audios/womenAudios/urduLanguage/callTo/nu-assit.mp3'
                : 'audios/womenAudios/callTo/nursingAsst.mp3'),
        CategoriesModel(
            name: 'Physiotherapist'.tr,
            image: 'assets/physco.png',
            menVoice: 'audios/menAudios/callTo/physio.mp3',
            womenVoice:selectedLang == 'Urdu'
                ? 'audios/womenAudios/urduLanguage/callTo/phso.mp3'
                : 'audios/womenAudios/callTo/physio.mp3'),
        CategoriesModel(
            name: 'Family'.tr,
